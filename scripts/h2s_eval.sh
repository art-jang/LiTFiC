#!/bin/bash
#SBATCH --job-name=llama_h2s_runs_extract # job name
...
srun python src/eval.py task_name=llama_hf_h2s_feat_pls_b50_train_extract experiment=llama3_haran_how2sign paths=how2sign \
    ckpt_path="logs/llama_hf_h2s_feat_pls_b50/runs/2024-11-07_22-50-41/checkpoints/epoch_epoch\=007.ckpt"\
    data.test_setname="train"\
    ...
    data.dataset_config.train_cap_prob=0.0\
